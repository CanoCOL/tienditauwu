                            ...
                            <>
                                <div className="col mt-5 mb-5 ">
                                    <div className="card h-100 align-content-center border-5 border-dark ">
                                        ...
                                        <h1 className="text-center   fs-3 mt-2">{cancion.name}</h1>
                                        <h1 className="text-center  fs-3 ">popularidad :{cancion.popularity}</h1>
                                        <audio controls className="mx-auto" src={cancion.preview_url}></audio>
                                    </div>
                                </div>
                            </>
